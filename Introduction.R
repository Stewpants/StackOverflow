...
ca = read.csv("CAhousing.csv") ## Lot's of difference ways to read in data...
...
train = data.frame(Y,CAdata$latitude,CAdata$longitude,Income, CAdata$totalRooms/CAdata$households)
test = data.frame(Y,CAdata$latitude,CAdata$longitude,Income,CAdata$totalRooms/CAdata$households)
